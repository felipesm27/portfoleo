...
export default function Menu() {
	...
	return (
		<nav className="flex gap-6">
			...
			<MenuItem
				href="https://api.whatsapp.com/send/?phone=5553981505220&text=phone_number&type=phone_number"
				selecionado={false}
				novaAba={true}
			>
				Contato
...
function MenuItem(props: {
	...
	return (
		<Link href={props.href} target={props.novaAba ? "_blank" : "_self"}>
			<span
				className={`flex items-center gap-2 text-sm border-green-300 hover:text-white ${
